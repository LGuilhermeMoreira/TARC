...
int main(int argc, char *argv[]) {
    ...
    positionAllocClients->Add(Vector(20.0, 20.0, 0.0));
    positionAllocClients->Add(Vector(10.0, 15.0, 0.0));
    positionAllocClients->Add(Vector(15.0, 10.0, 0.0));
    ...
    positionAllocInterferer->Add(Vector(12.0, 12.0, 0.0));
    ...
    AnimationInterface anim("simulation_2_v1.xml");
    ...
    anim.SetConstantPosition(interfererNode.Get(0), 12.0, 12.0);
    ...
    monitor->SerializeToXmlFile("simulation2_v1.flowmon", false, false);
