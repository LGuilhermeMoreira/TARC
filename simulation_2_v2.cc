...
int main(int argc, char *argv[]) {
    ...
    positionAllocAp->Add(Vector(7.5, 7.5, 0.0));
    ...
    positionAllocClients->Add(Vector(0.0, 7.5, 0.0));
    positionAllocClients->Add(Vector(7.5, 15.0, 0.0));
    positionAllocClients->Add(Vector(15.0, 7.5, 0.0));
    ...
    positionAllocInterferer->Add(Vector(7.5, 0.0, 0.0));
    ...
    AnimationInterface anim("simulation_2_v2.xml");
    ...
    // Posicionando os nós
    anim.SetConstantPosition(apNode.Get(0), 7.5, 7.5);
    ...
    anim.SetConstantPosition(interfererNode.Get(0), 7.5, 0.0);
    ...
    monitor->SerializeToXmlFile("simulation2_v2.flowmon", false, false);
